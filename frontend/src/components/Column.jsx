...
export default function Column({ side = 'left' }) {
  ...
  return (
    ...
    >
      ...
      />
      {/* Abacus (top slab) */}
      <rect x="4" y="14" width="48" height="6" rx="1" fill="#C4BAB0" />
      ...
      />
      {/* Capital band */}
      <rect x="10" y="38" width="36" height="4" rx="1" fill="#C4BAB0" />

      {/* === Shaft === */}
      <rect x="14" y="42" width="28" height="340" rx="1" fill="#D8D0C4" />
      ...
      <rect x="10" y="382" width="36" height="5" rx="2" fill="#C4BAB0" />
      ...
      />
      {/* Lower torus */}
      <rect x="8" y="392" width="40" height="5" rx="2" fill="#C4BAB0" />
      {/* Plinth */}
      <rect x="4" y="397" width="48" height="8" rx="1" fill="#B8AFA5" />
